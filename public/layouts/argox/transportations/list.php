<?php
function render_transportation_list_html( $item, $get_view, $plugin_name ) {
	...
	<div class="tim_item swiper-slide">
		...
		<div<?php echo $class_desc_column; ?>>
			<div class="tim_item_desc">
				...
				<ul>
					<li>
						<span class="tim_label tim_label_default"><?php echo $item['product_category_name']; ?></span>
					</li>
				</ul>
				...
				<ul>
					<li>
						<i class="fa fa-map-marker fa-lg tim-fa-fixed"></i><?php _e( 'From', $plugin_name ); ?> <b><?php echo $item['departure_location_name'] ?></b> <?php _e( 'to', $plugin_name ); ?> <b><?php echo $item['arrival_location_name'] ?></b>
					</li>
					<li>
						<i class="fa fa-clock-o fa-lg tim-fa-fixed"></i><?php echo $item['duration']; ?>
					</li>
				</ul>
		...
		<div<?php echo $class_price_column; ?>>
			<div class="tim_item_price">
				...
				<a href="<?php echo $item['link']; ?>" class="tim_item_btn"><?php _e( 'Details', $plugin_name ); ?></a>
			</div>
		</div>
	</div>
	<?php
