    ...
    <div class="tim_detail">
        <div class="tim_row tim_detail_title_wrapper">
            <div class="tim_col_7 tim_detail_title">
                ...
                <em><i class="fa fa-map-marker fa-lg"></i> <?php echo $item['parentLocation_name']; ?>, <?php echo $item['country_name']; ?></em>
            </div>
            <div class="tim_col_5 tim_pull_right">
                <div class="tim_detail_menu_wrap">
                    <ul class="tim_detail_menu">
                        ...
                        <?php
                        if ( $item['geo_lat'] != '' ){
                            ?><li><a href="javascript:void(0);" onclick="timScrollTo('tim_detail_video')"><i class="fa fa-map-marker fa-lg"></i><span><?php _e( 'Map', $plugin_name ); ?></span></a></li><?php
                        }
                        if ( $item['url_video'] != '' ){
                            ?><li><a href="javascript:void(0);" onclick="timScrollTo('tim_detail_map')"><i class="fa fa-video-camera fa-lg"></i><span><?php _e( 'Video', $plugin_name ); ?></span></a></li><?php
                        }
                        if ($hotelsByLocation){
