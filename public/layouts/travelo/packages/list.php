...
function render_package_list_html( $item, $get_view, $plugin_name ){
	...
	<div class="tim_item swiper-slide">
		...
		<div class="<?php echo $class_desc_column; ?>tim_item_desc">
			...
			?>
			<ul class="tim_tags">
				<li><i class="fa fa-clock-o fa-lg"></i><?php echo $item['days']; ?> <?php _e( 'days', $plugin_name ); ?> / <?php echo $item['nights']; ?> <?php _e( 'nights', $plugin_name ); ?></li>
				<li><i class="fa fa-map-marker fa-lg"></i><?php _e( 'Departure', $plugin_name ); ?>: <b><?php echo $item['departureLocation_name'] ?></b></li>
				<li><i class="fa fa-map-marker fa-lg"></i><?php _e( 'Arrival', $plugin_name ); ?>: <b><?php echo $item['arrivalLocation_name'] ?></b></li>
			</ul>
		</div>
