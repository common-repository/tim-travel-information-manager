...
function render_check_rate_widget( $item, $checkRateLayoutId = '', $datePickerOption = '' ) {
            ...
            <form action="#" name="tim_check_rates" class="tim_check_rate_form" autocomplete="off">
                ...
                <div class="timGuestsField">
                    <p>
                        ...
                        <select id="timAdults" name="timAdults" onchange="timCheckTourRates();">
                        <?php
                    ...
                    <p>
                        ...
                        <select id="timChildren" name="timChildren" onchange="timCheckTourRates('children');">
                        <?php
                    ...
                    <p>
                        ...
                        <select id="timInfants" name="timInfants" onchange="timCheckTourRates();">
                        <?php
                        for ($i = 0; $i <= 50; $i++){
                ...
                <div class="tim_clr">
                    ...
                    <div class="tim_col_6">
                        ...
                        <div class="timGuestsField">
                            ...
                            <p>
                                <?php _e( 'Children', $plugin_name ); ?>:
                                <select id="timChildren" name="timChildren" onchange="timCheckTourRates();">
                                <?php
                                for ($i = 0; $i <= $max_pax_allowed; $i++){
                                    echo '<option'. selected( $children, $i ) .' value="'. $i .'">'. $i .'</option>';
                                }
    ...
    jQuery( function() { // added only here to avoid issues with datepicker onSelect
        timProductDatePicker('tour', 1, '<?php echo $content_language; ?>');
